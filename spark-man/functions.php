    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', 'Raw power cannot outshine the spark of friendship! Come be my friend!');
                    break;
                }
                case 'jupiter': {
                    $this_robot->set_quote('battle_victory', 'Strangers are just friends you haven\’t met! If you want a planet, share mine!');
                    break;
                }
            }
        }
