    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'proto-man': {
                    $this_robot->set_quote('battle_victory', 'Are you really as dumb as those shades make you look?');
                    break;
                }
                case 'gravity-man': {
                    $this_robot->set_quote('battle_victory', 'You know, I still haven\’t forgiven you for flinging that tree into our institute… ');
                    break;
                }
                case 'heat-man': {
                    $this_robot->set_quote('battle_victory', 'Ahh, the lighter robot.. defeated by the lighting robot!');
                    break;
                }
            }
        }
