    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'guts-man': {
                    $this_robot->set_quote('battle_victory', 'Hey, Guts! Enough show-boating, and let\’s grab a drink already!');
                    break;
                }
                case 'flash-man': {
                    $this_robot->set_quote('battle_victory', 'Oh, oh, I know you! You\’re the ‘before-and-after’ guy in the hair loss commercials!');
                    break;
                }
                case 'star-man': {
                    $this_robot->set_quote('battle_victory', 'As your bro, let me be real.. your movies could use some way tighter editing.');
                    break;
                }
            }
        }
