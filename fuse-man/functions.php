    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'spark-man': {
                    $this_robot->set_quote('battle_victory', 'Cool it with the ‘buddy-buddy’ stuff! I’ve got a job to do! ');
                    break;
                }
                case 'concrete-man': {
                    $this_robot->set_quote('battle_victory', 'If I need to work, and you need to work.. why are we even fighting?');
                    break;
                }
            }
        }
