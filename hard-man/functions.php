    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'snake-man': {
                    $this_robot->set_quote('battle_victory', 'You who only uses dirty tricks cannot understand a hard-fought victory.');
                    break;
                }
                case 'knight-man': {
                    $this_robot->set_quote('battle_victory', 'It is good to meet a robot in combat who understands the value of a fair fight!');
                    break;
                }
            }
        }
