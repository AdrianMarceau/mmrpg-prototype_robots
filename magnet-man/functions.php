    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'magnet-man': {
                    $this_robot->set_quote('battle_victory', 'As attractive as you are, you seem to keep repelling me!');
                    break;
                }
                case 'wood-man': {
                    $this_robot->set_quote('battle_victory', 'My magnets home in on wood? How fortunate...');
                    break;
                }
                case 'roll': {
                    $this_robot->set_quote('battle_victory', 'Oh, don\’t make that face, sweetheart. You know you find me hopelessly attractive!');
                    break;
                }
            }
        }
