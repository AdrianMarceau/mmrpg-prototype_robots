    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'crash-man': {
                    $this_robot->set_quote('battle_victory', 'A shame to destroy a fellow destroyer, but a pleasure all the same!');
                    break;
                }
                case 'ground-man': {
                    $this_robot->set_quote('battle_victory', 'Everything must burn to the ground!');
                    break;
                }
                case 'king': {
                    $this_robot->set_quote('battle_victory', 'You told me to destroy everything.. How\’d I do?');
                    break;
                }
            }
        }
