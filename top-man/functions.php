    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'quick-man': {
                    $this_robot->set_quote('battle_victory', 'Sure you\’re fast, but you\’ve got no style!');
                    break;
                }
                case 'hard-man': {
                    $this_robot->set_quote('battle_victory', 'Weaknesses are no substitute for style, my friend!');
                    break;
                }
                case 'tornado-man': {
                    $this_robot->set_quote('battle_victory', 'Nice try, but no one spins as well as me!');
                    break;
                }
            }
        }
