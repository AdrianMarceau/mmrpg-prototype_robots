    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', 'HAHAHA! You\’re crazy - I like you, man!');
                    break;
                }
                case 'drill-man': {
                    $this_robot->set_quote('battle_victory', 'That\’s your idea of an explosion? I could take your job!');
                    break;
                }
                case 'bomb-man': {
                    $this_robot->set_quote('battle_victory', 'Hah! There\’s a REAL “party” for you!');
                    break;
                }
                case 'hard-man': {
                    $this_robot->set_quote('battle_victory', 'Your puny cera-whatever defenses mean nothing to the mighty destroyer!');
                    break;
                }
            }
        }
