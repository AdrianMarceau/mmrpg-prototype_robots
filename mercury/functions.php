    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'duo': {
                    $this_robot->set_quote('battle_victory', 'HoohooHOO, gimme all that sweet Starforce energy!');
                    $this_robot->set_quote('battle_defeat', 'If you won\’t let me have this world.. Then let Sunstar come and burn it all!');
                    break;
                }
            }
        }
