    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'drill-man': {
                    $this_robot->set_quote('battle_victory', '.. Away with you. Your drilling disrupts my treasure hidden below.');
                    break;
                }
                case 'pirate-man': {
                    $this_robot->set_quote('battle_victory', 'The treasure of the land is mine. Take your greed to your sea.');
                    break;
                }
            }
        }
