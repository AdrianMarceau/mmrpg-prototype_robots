    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', '... Dude, chill. You\’re giving me a migraine.');
                    break;
                }
                case 'time-man': {
                    $this_robot->set_quote('battle_victory', 'Whoa, you look ticked….wanna come to my barbecue later?');
                    break;
                }
                case 'fire-man': {
                    $this_robot->set_quote('battle_victory', 'I dunno, man. Justice seems like a drag...');
                    break;
                }
            }
        }
