    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'guts-man': {
                    $this_robot->set_quote('battle_victory', 'Wow, you\’re strong for an old guy! Your cardio regiment must be wild!');
                    break;
                }
                case 'skull-man': {
                    $this_robot->set_quote('battle_victory', 'You took it too far, man! You\’ve worked yourself to the bone! ');
                    break;
                }
                case 'pharaoh-man': {
                    $this_robot->set_quote('battle_victory', 'Hey.. You should join my hot yoga class. ');
                    break;
                }
            }
        }
