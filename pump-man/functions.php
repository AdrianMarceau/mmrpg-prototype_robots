    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'junk-man': {
                    $this_robot->set_quote('battle_victory', 'Oh.. oh my… I\’m gonna throw up!!!');
                    break;
                }
                case 'dust-man': {
                    $this_robot->set_quote('battle_victory', 'Clean up all you want, but whatever you do, keep that putrid breath of yours away from me!');
                    break;
                }
                case 'solar-man': {
                    $this_robot->set_quote('battle_victory', 'I get you\’re a fitness guy, but I\’m not that type of \‘Pump\’ Man. ');
                    break;
                }
            }
        }
