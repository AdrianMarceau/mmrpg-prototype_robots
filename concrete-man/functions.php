    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'guts-man': {
                    $this_robot->set_quote('battle_victory', 'If only you were as tough as your talk, Guts!');
                    break;
                }
                case 'drill-man': {
                    $this_robot->set_quote('battle_victory', 'You lazy drillhead! Battles aren\’t something you can shirk -- and neither is work! ');
                    break;
                }
            }
        }
