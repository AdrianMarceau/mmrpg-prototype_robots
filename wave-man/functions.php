    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'oil-man': {
                    $this_robot->set_quote('battle_victory', 'And don\’t let me catch you in my oceans ever again...');
                    break;
                }
                case 'spark-man': {
                    $this_robot->set_quote('battle_victory', 'For Ahab\’s sake, get away! Waaah! I\’ll harpoon you before you ever become my friend!');
                    break;
                }
                case 'dynamo-man': {
                    $this_robot->set_quote('battle_victory', 'You stay away from me and I\’ll stay away from you. Capiche?');
                    break;
                }
                case 'neptune': {
                    $this_robot->set_quote('battle_victory', 'The people of this Earth may be obnoxious at times, but I will not let you harm them all the same!');
                    break;
                }
            }
        }
