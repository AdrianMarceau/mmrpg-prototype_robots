    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'ice-man': {
                    $this_robot->set_quote('battle_victory', 'Ice Man-sempai! Waaah! I\’m sorry for hurting you!');
                    break;
                }
                case 'crystal-man': {
                    $this_robot->set_quote('battle_victory', 'You\’re so flashy - but not as flashy as moi!');
                    break;
                }
            }
        }
