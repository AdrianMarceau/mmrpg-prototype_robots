    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'enker': {
                    $this_robot->set_quote('battle_victory', 'Nihon no seishin wa anata no kokoro ni tsuyoidesu.');
                    break;
                }
                case 'tengu-man': {
                    $this_robot->set_quote('battle_victory', 'Jaakuna tengu! Jigoku ni modotte!');
                    break;
                }
            }
        }
