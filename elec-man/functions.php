    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'mega-man': {
                    $this_robot->set_quote('battle_victory', 'Isn’t it obvious? No one can withstand my Thunder Beams – especially not you!');
                    break;
                }
                case 'quick-man': {
                    $this_robot->set_quote('battle_victory', 'You’re quick, but you have yet to match my lightning speed!');
                    break;
                }
                case 'plug-man': {
                    $this_robot->set_quote('battle_victory', '…So, run it by me again, what’s an otaku?');
                    break;
                }
            }
        }
