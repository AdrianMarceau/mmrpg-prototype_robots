    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'dive-man': {
                    $this_robot->set_quote('battle_victory', 'Yaaar, now scurry off to land if ye knows what\’s best for ya, ye bilge-sucking privateer.');
                    break;
                }
                case 'shadow-man': {
                    $this_robot->set_quote('battle_victory', 'The age-old matter \'tis been answered! A pirate takes his cutlass to a ninja eh\'vry time!');
                    break;
                }
            }
        }
