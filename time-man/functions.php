    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'mega-man': {
                    $this_robot->set_quote('battle_victory', 'You were never this slow before.');
                    break;
                }
                case 'oil-man': {
                    $this_robot->set_quote('battle_victory', 'Late as always, Oil Man.');
                    break;
                }
                case 'centaur-man': {
                    $this_robot->set_quote('battle_victory', 'Of course.. the centaur stops time.');
                    break;
                }
            }
        }
