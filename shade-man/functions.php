    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', 'This marks the second time you\’ve fallen to me, my boy!');
                    break;
                }
                case 'splash-woman': {
                    $this_robot->set_quote('battle_victory', 'My dear sweet angel - surely you are in need of more *classy* company?');
                    break;
                }
            }
        }
