    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'air-man': {
                    $this_robot->set_quote('battle_victory', 'Well, well, it looks like your design works much better for me than it does for you!');
                    break;
                }
                case 'spark-man': {
                    $this_robot->set_quote('battle_victory', 'Will you stop pestering me with your obnoxious “friendship” now!?');
                    break;
                }
                case 'bubble-man': {
                    $this_robot->set_quote('battle_victory', 'Hate to burst your bubble, man, but you can’t beat my pinpoint accuracy!');
                    break;
                }
            }
        }
