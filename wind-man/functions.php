    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'cut-man': {
                    $this_robot->set_quote('battle_victory', 'Ah, Kung Fu Cut Man! I hope my strikes will be as sharp as yours some day!');
                    break;
                }
                case 'torch-man': {
                    $this_robot->set_quote('battle_victory', 'I bow to a fellow martial artist. The both of us will only get stronger from here.');
                    break;
                }
            }
        }
