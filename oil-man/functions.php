    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'mega-man': {
                    $this_robot->set_quote('battle_victory', 'Yo, Mega - this ain\’t you! Let\’s throw it back, one more time!');
                    break;
                }
                case 'time-man': {
                    $this_robot->set_quote('battle_victory', 'Late or not, I still kicked your butt, man!');
                    break;
                }
                case 'fire-man': {
                    $this_robot->set_quote('battle_victory', 'I appreciate the energy, but, uh, try to keep the flames away from me, \‘kay?');
                    break;
                }
            }
        }
