    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'spring-man': {
                    $this_robot->set_quote('battle_victory', 'Racing, battling, it doesn\'t matter… I can defeat you in anything!');
                    break;
                }
                case 'mars': {
                    $this_robot->set_quote('battle_victory', 'Hey, nice gear! What gun show did you get your stuff from?');
                    break;
                }
            }
        }
