    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', 'Woah. You\’re, like.. A lot less scary than I thought.');
                    break;
                }
                case 'top-man': {
                    $this_robot->set_quote('battle_victory', 'HAHAH! How were you gonna beat anyone with a stupid weapon like that?!');
                    break;
                }
                case 'dive-man': {
                    $this_robot->set_quote('battle_victory', 'Hmph, people like you who patrol around, as if they own the sea… That\’s my job!');
                    break;
                }
            }
        }
