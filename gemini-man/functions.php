    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'gemini-man': {
                    $this_robot->set_quote('battle_victory', ' ...I can\’t even keep count of all the copies I\’ve made anymore.');
                    break;
                }
                case 'search-man': {
                    $this_robot->set_quote('battle_victory', '..Woah. How\'d he duplicate his head like that?');
                    break;
                }
            }
        }
