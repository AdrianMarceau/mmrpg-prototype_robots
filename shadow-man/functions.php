    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'mega-man': {
                    $this_robot->set_quote('battle_victory', 'Sliding\’s nothing special, kid.');
                    break;
                }
                case 'terra': {
                    $this_robot->set_quote('battle_victory', 'I owe you everything I am, but this planet.. This is my home!');
                    break;
                }
                case 'pirate-man': {
                    $this_robot->set_quote('battle_victory', 'I have no interest in childish debates!.. but obviously, a ninja would always defeat a pirate.');
                    break;
                }
            }
        }
