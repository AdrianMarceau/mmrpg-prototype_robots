    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'bass': {
                    $this_robot->set_quote('battle_victory', ' Heheh.. I\’m Wily’s first, and still his greatest.');
                    break;
                }
                case 'metal-man': {
                    $this_robot->set_quote('battle_victory', 'It’s fitting that only I can make quick work of myself!');
                    break;
                }
                case 'magnet-man': {
                    $this_robot->set_quote('battle_victory', 'Hey! Nice helmet!');
                    break;
                }
                case 'cut-man': {
                    $this_robot->set_quote('battle_victory', ' Stop with the awful puns, kid, and maybe you\’ll be as good as me someday.');
                    break;
                }
            }
        }
