    ...
    'robot_function_ontargetchange' => function($objects){
        ...
        if (true) {
            switch ($target_robot->robot_token){
                case 'yamato-man': {
                    $this_robot->set_quote('battle_victory', 'As stalwart as e\’er, Yamato Man, but thy loss hast only augmented my streak of victories!');
                    break;
                }
                case 'clown-man': {
                    $this_robot->set_quote('battle_victory', 'Alas, poor Clown Man! I knew him well!');
                    break;
                }
            }
        }
